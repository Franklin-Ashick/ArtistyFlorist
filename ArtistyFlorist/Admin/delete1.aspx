<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="delete1.aspx.cs" Inherits="ArtistyFlorist.Admin.delete1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    string query = "DELETE FROM Products WHERE ProductID=@loginID";
